...
.. grid:: 1 1 2 2
    ...
    .. grid-item-card::
        ...
        **Getting Started**
        ...
        Learn how to install dependencies and get started with Solar Orbiter data.
    ...
    .. grid-item-card::
        ...
        **Analysis Tools**
        ...
        Tools for analyzing Solar Orbiter data using SunPy and other Python packages.
    ...
    .. grid-item-card::
        ...
        **Example Gallery**
        ...
        Browse interactive examples demonstrating Solar Orbiter data analysis.
