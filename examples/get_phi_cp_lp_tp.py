...
plt.imshow(CP, cmap = 'gist_heat', origin = "lower", vmin = -5e-2 ,vmax = 5e-2)
...
plt.figure(figsize = (8, 8))
plt.imshow(LP, cmap = 'inferno', origin = "lower", vmin = 0 ,vmax = 5e-2)
plt.colorbar(fraction=0.046)
...
plt.figure(figsize = (8, 8))
plt.imshow(TP, cmap = 'cividis', origin = "lower", vmin = 0 ,vmax = 5e-2)
plt.colorbar(fraction=0.046)
